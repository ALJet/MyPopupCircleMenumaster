...
public class PathUtil {
     ...
     * @return
     */
    public static Path genPath(RectF mArcRange,
                               Context context,
                               EnumOverScreen overScreen){
        Path path = new Path();
        int start = 180;
        int overDis = Math.abs(overScreen
        .getOverScreenDistance());
     ...
     * @return
     */
    public static Path genDriectPath(RectF mArcRange,
                                     int mOpenDriction){
        Path path = new Path();
        int startDegree = 0;
    ...
    private static int px2dip(Context context,
                              float pxValue){
